...
- if the hidden word contains that letter, it is displayed (once or multiple times, depending on the word)
...
- if the player guesses the word wrong, or chooses not to attempt a guess, the game loops back to prompt for a letter
